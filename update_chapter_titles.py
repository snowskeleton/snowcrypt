...
class FFMeta:
    ...
    def update_title_from_api_meta(self, api_meta):
        ...
        # except:
        #     if api_meta.count_chapters() == self.count_chapters() + 2:
        #         pass

            # print('api_meta chapters', api_meta.count_chapters(),
            #       'actual chapters', self.count_chapters())
            # import sys
            # sys.exit()
        ...
        for chapter in api_meta.get_chapters():
            ...
            for key, value in chapter.items():
                if key == "title":
                    if chapter['title'] == 'Opening Credits' or chapter['title'] == 'End Credits':
                        num_chap -= 1
                        continue
